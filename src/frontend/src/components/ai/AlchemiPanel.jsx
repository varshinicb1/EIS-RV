...
const SOURCE_BADGE = {
  curated_db:   { label: 'Curated DB',  color: 'var(--color-success)',
      ...
      <div className="card" style={{ gridRow: '1/3', overflow: 'auto' }}>
        <div className="card-header">
          <div>
            <div className="card-title" style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              <span style={{ color: 'var(--color-success)', fontSize: 14 }}>{'◆'}</span> Alchemi
            </div>
        ...
        <div style={{
          ...
          {statusError ? (
            ...
            <>
              <div><strong style={{ color: 'var(--color-success)' }}>Online:</strong> {status.model}</div>
                ...
                {chatLog.length === 0 ? (
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ fontSize: 9, fontWeight: 600,
                                  color: m.role === 'user' ? 'var(--color-success)'
              ...
              <table style={{ width: '100%', fontSize: 11, borderCollapse: 'collapse' }}>
                <tbody>
                  <tr style={{ borderBottom: '1px solid var(--border-primary)' }}>
                    ...
                    <td style={{ padding: '6px 8px', color: status.configured ? 'var(--color-success)' : '#f59e0b' }}>
