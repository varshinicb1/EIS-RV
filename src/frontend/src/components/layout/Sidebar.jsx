...
const ICONS = {
  ...
  circuit: Cpu,
  toolkit: Calculator,
  unified_spectroscopy: Layers,
  advanced_analysis: BarChart2,
  materials: Database,
  discovery: Wand2,
  identify: Microscope,
  data: ArrowUpToLine,
  lab: FlaskConical,
  lab_cleaner: FlaskConical,
  reallab: FlaskConical,
...
const GROUPS = [
  ...
  { label: 'Lab & Data',       keys: ['reallab', 'lab', 'lab_cleaner', 'data'] },
  { label: 'Workspace',        keys: ['workspace', 'reports', 'publication', 'validation', 'profile'] },
];
