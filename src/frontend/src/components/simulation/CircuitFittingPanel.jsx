...
export default function CircuitFittingPanel() {
  ...
  useEffect(() => {
    ...
    // Grid - light gray for scientific plots
    ...
    // Fit line - red
    if (Zfr.length) {
      ctx.beginPath(); ctx.strokeStyle = '#DC2626'; ctx.lineWidth = 2;
    ...
    // Labels - Times New Roman for publication
    ...
    // Legend
    ctx.textAlign = 'left'; ctx.font = '10px "Times New Roman", Times, serif';
    ctx.fillStyle = '#2563EB'; ctx.fillRect(w - 120, pad.t + 5, 8, 8);
    ctx.fillStyle = '#111827'; ctx.fillText('Data', w - 108, pad.t + 13);
    ctx.fillStyle = '#DC2626'; ctx.fillRect(w - 120, pad.t + 20, 8, 8);
    ctx.fillStyle = '#111827'; ctx.fillText('Fit', w - 108, pad.t + 28);
