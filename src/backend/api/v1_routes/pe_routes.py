...
async def list_pe_materials_endpoint():
    """List printed electronics materials."""
    return {"materials": ["activated_carbon", "MnO2", "zinc", "silver_nanoparticles", "PEDOT_PSS", "carbon_black", "PET", "PI", "paper"]}
