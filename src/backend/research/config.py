...
SEARCH_QUERIES = [
    ...
    # MXenes & 2D materials
    "Ti3C2Tx MXene supercapacitor electrochemical",
    "MoS2 nanosheet electrode voltammetry",
    "MXene biosensor electrochemical impedance",
    "black phosphorus electrode energy storage",
    # MOFs & COFs
    "ZIF-67 derived carbon electrode supercapacitor",
    "MOF electrode electrochemical sensor",
    "UiO-66 biosensor impedimetric",
    "covalent organic framework electrode",
    # Biosensors & clinical
    "aptasensor electrochemical heavy metal detection",
    "glucose biosensor non-enzymatic nanocomposite",
    "immunosensor impedimetric cortisol detection",
    "wearable sweat sensor electrochemical",
    "molecularly imprinted polymer electrochemical sensor",
    # Energy storage advanced
    "NiCo-LDH asymmetric supercapacitor",
    "solid-state battery impedance spectroscopy",
    "lithium sulfur battery EIS",
    "zinc-air battery electrocatalyst",
    # Perovskites & photocatalysis
    "perovskite photoelectrochemical water splitting",
    "BiVO4 photoanode impedance spectroscopy",
    "CsPbBr3 quantum dot solar cell",
]
